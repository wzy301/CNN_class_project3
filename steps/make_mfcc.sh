...
export PATH="$PATH:/scratch/zxw190002/kaldi/tools/ffmpeg"
export LD_LIBRARY_PATH="$LD_LIBRARY_PATH:/scratch/zxw190002/kaldi/tools/ffmpeg_tool/lib"
nj=4
cmd=run.pl
...
if [ -f $data/segments ]; then
  ...
  $cmd JOB=1:$nj $logdir/make_mfcc_${name}.JOB.log \
    ...
    compute-mfcc-feats $vtln_opts $write_utt2dur_opt --verbose=2 --allow-upsample=true\
